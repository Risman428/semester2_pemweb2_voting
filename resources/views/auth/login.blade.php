...
<head>
    ...
    <title>Login - Voting Online Ketua BEM</title>
...
<body>
    ...
    <section class="login-hero text-center">
        <div class="container">
            <h1 class="display-5 fw-bold mb-3">MASUK KE AKUN ANDA</h1>
            <p class="lead">Gunakan hak suara Anda untuk menentukan masa depan kampus</p>
        </div>
    </section>
            ...
            <div class="login-card-body">
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="d-grid gap-2">
                        <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-sign-in-alt me-2"></i>Masuk</button>
                    </div>
                </form>
                ...
                <div class="text-center mt-4">
                    <p>Belum punya akun? <a href="{{ route('register') }}" class="text-primary">Daftar disini</a></p>
